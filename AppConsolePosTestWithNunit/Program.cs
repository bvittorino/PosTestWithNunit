            ...
            try
            {
                ...
                {       
                    ...
                    */
                    ...
                    Assert.AreEqual("122.95", xmlStruct.riepilogos[1].Ammontare, "Errore campo Ammontare relativo alla IVA" + xmlStruct.riepilogos[1].AliquotaIVA + ", expected " + "118,85" + " received " + xmlStruct.riepilogos[1].Ammontare);
                    Assert.AreEqual("118.85", xmlStruct.riepilogos[1].ImportoParziale, "Errore campo ImportoParziale relativo alla IVA" + xmlStruct.riepilogos[1].AliquotaIVA + ", expected " + "100,00" + " received " + xmlStruct.riepilogos[1].ImportoParziale);
                    ...
                    */
                    Assert.AreEqual("100.00", xmlStruct.riepilogos[0].Ammontare, "Errore campo Ammontare relativo alla IVA" + xmlStruct.riepilogos[0].AliquotaIVA + ", expected " + "100,00" + " received " + xmlStruct.riepilogos[0].Ammontare);
                    Assert.AreEqual("96.67", xmlStruct.riepilogos[0].ImportoParziale, "Errore campo ImportoParziale relativo alla IVA" + xmlStruct.riepilogos[0].AliquotaIVA + ", expected " + "3,33" + " received " + xmlStruct.riepilogos[0].ImportoParziale);
        ...
        public void TestAnnulloUtilizzoBuonoMonouso()
        {
            ...
            try
            {
                ...
                */
                ...
                try
                {
                    Assert.AreEqual(totGiorn + 1220000, totGiornUpdated, "Test Totale Giornaliero Failed sul metodo TestAnnulloUtilizzoBuonoMonouso, expected " + (totGiorn + 1220000) + "received " + totGiornUpdated);
