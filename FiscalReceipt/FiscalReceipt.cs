...
namespace FiscalReceipt.Library
{
            ...
            try
            {
                ...
                */
                ...
                if (isRT)
                {
                    ...
                    fiscalprinter.PrintRecItem("TSHIRT", (decimal)10000, (int)1000, (int)2, (decimal)11000, "");
                    fiscalprinter.PrintRecItem("CAPPELLO", (decimal)10000, (int)1000, (int)3, (decimal)31200, "");
                    ...
                    fiscalprinter.PrintRecItem("TEST Non Riscosso Servizi", (decimal)10000, (int)1000, (int)10, (decimal)100000, "");
                    ...
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)10000, "600SCONTO A PAGARE GEN");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)10000, "601BUONO MULTIUSO");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)10000, "502Non Riscosso Servizi");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)10000, "501Non Riscosso Beni");
                    //fiscalprinter.PrintRecTotal((decimal)192000, (decimal)10000, "500Non Riscosso Gen");
                    
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "200CREDITO");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "100ASSEGNO");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "201CARTA DI CREDITO");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "203ALTRO PAGAMENTO");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "204BANCOMAT");
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)20000, "301TICKET");
                    
                    fiscalprinter.PrintRecTotal((decimal)192000, (decimal)000000, "000CONTANTI");
                    ...
                    fiscalprinter.PrintRecRefund("SCARPE", (decimal)100000, (int)1);
                    fiscalprinter.PrintRecRefund("TSHIRT", (decimal)11000,  (int)2);
                    fiscalprinter.PrintRecRefund("CAPPELLO", (decimal)31200,  (int)3);
                    fiscalprinter.PrintRecRefund("BORSA", (decimal)50100,  (int)4);
                    fiscalprinter.PrintRecRefund("TEST SCONTO A PAGARE GEN", (decimal)100000,  (int)1 );
                    fiscalprinter.PrintRecRefund("TEST BUONO MULTIUSO", (decimal)100000,  (int)1 );
                    fiscalprinter.PrintRecRefund("TEST Non Riscosso Servizi", (decimal)100000, (int)10 );
                    fiscalprinter.PrintRecRefund("TEST Non Riscosso Beni", (decimal)100000,  (int)1 );
                    fiscalprinter.PrintRecRefund("TEST Non Riscosso Gen", (decimal)100000,  (int)1 );
        ...
        */
        ...
        public int TestVoidableRefundableReceipts(string zrep, string start, string finish, string data)
        {
            try
            {
                ...
                printerIdNumber = strData.Substring(4, 6);
                printerIdManufacturer = strData.Substring(2, 2);
                string printerId = printerIdManufacturer + "I" + printerIdModel + printerIdNumber;
                /*
                string recNum = fiscalprinter.GetData(FiscalData.FiscalReceipt, (int)0).Data;
                string zRepNum = fiscalprinter.GetData(FiscalData.ZReport, (int)0).Data;
                int nextInt = Int32.Parse(zRepNum) + 1;
        ...
        public int SetRetailHeaderLine()
        {
            try
            {
                ...
                appoggio = "ITäöüß07511580156".PadRight(40, ' ');
                
                byte[] weirdchar = new byte[] { 0xe4, 0xf6, 0xfc, 0xdf };

                //string s = Encoding.ASCII.GetString(weirdchar);

                string s = Encoding.UTF8.GetString(weirdchar);
                byte[] b = Encoding.GetEncoding(437).GetBytes("äöüß");

                // Instantiate an UTF8 encoding object.
                UTF8Encoding utf8 = new UTF8Encoding(); ;

                // Create an ASCII byte array.
                Byte[] bytes = utf8.GetBytes(appoggio);
                ...
                strObj[0] = "02" + appoggio.PadRight(40, ' ');
                dirIO = posCommonFP.DirectIO(0, 3016, strObj);
                appoggio = "ITèìàò07511580156".PadRight(40, ' ');
    ...
    public class Xml2 : FiscalReceipt
    {
        ...
        //Per alcune forme di pagamento piu rognose fa l'annulla subito dopo per vedere l'xml derivante se è ok
        public int FormePagamentoXml20()
        {
            try
            {
               log.Info("Performing FormePagamentoXml20() Method");
                ...
                fiscalprinter.PrintRecItem("TEST CONTANTE", (decimal)500, (int)1000, (int)1, (decimal)500, "");
                ...
                fiscalprinter.PrintRecItem("TEST CREDITO", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "200CREDITO");
                ...
                fiscalprinter.PrintRecItem("TEST ASSEGNO", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "100ASSEGNO");
                ...
                fiscalprinter.PrintRecItem("TEST CARTA DI CREDITO", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "201CARTA DI CREDITO");
                ...
                fiscalprinter.PrintRecItem("TEST ALTRO PAGAMENTO", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "203ALTRO PAGAMENTO");
                ...
                fiscalprinter.PrintRecItem("TEST BANCOMAT", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "204BANCOMAT");
                ...
                fiscalprinter.PrintRecItem("TEST TICKET", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "301TICKET");
                ...
                fiscalprinter.PrintRecItem("TEST Non Riscosso Gen", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "500Non Riscosso Gen");
                ...
                app = 1;
                // Annullo Esempio 1
                strObj[0] = "0140001VOID " + (Convert.ToInt32(gc.ZRep) + 1).ToString().PadLeft(4, '0') + " " + app.ToString().PadLeft(4, '0') + " " + data + " " + printerId;
                dirIO = posCommonFP.DirectIO(0, 1078, strObj);
                iData = dirIO.Data;
                if (iData != 1078)
                {
                ...
                fiscalprinter.PrintRecItem("TEST Non Riscosso Beni", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "501Non Riscosso Beni");
                ...
                printerIdNumber = strData.Substring(4, 6);
                printerIdManufacturer = strData.Substring(2, 2);
                printerId = printerIdManufacturer + model + printerIdModel + printerIdNumber;

                app = Convert.ToInt32(gc.FiscalRec) + 1;
                ...
                fiscalprinter.PrintRecItem("TEST Non Riscosso Servizi", (decimal)500, (int)1000, (int)10, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "502Non Riscosso Servizi");
                ...
                fiscalprinter.PrintRecItem("TEST SCONTO A PAGARE GEN", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "600SCONTO A PAGARE GEN");
                ...
                fiscalprinter.PrintRecItem("TEST BUONO MULTIUSO", (decimal)500, (int)1000, (int)1, (decimal)500, "");

                fiscalprinter.PrintRecTotal((decimal)500, (decimal)500, "601BUONO MULTIUSO");
                ...
                fiscalprinter.PrintRecItem("TEST PAMANENTO MULTIPLI", (decimal)700, (int)1000, (int)1, (decimal)700, "");

                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "000CONTANTI");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "200CREDITO");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "100ASSEGNO");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "201CARTA DI CREDITO");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "203ALTRO PAGAMENTO");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "204BANCOMAT");
                fiscalprinter.PrintRecTotal((decimal)700, (decimal)100, "301TICKET");
        ...
        public int NonRiscossoDaSSN(ref string zRep)
        {
            try
            {
                log.Info("Performing NonriscossoDaSSN Method() Esempio 22");
                string[] strObj = new string[1];
                DirectIOData dirIO;
                int iData;
                object iObj;
        ...
        public int testCNR()
        {
            try
            {
                ...
                */
                ...
                fiscalprinter.PrintRecItem("Servizio 10", (decimal)5000000, (int)1000, (int)11, (decimal)5000000, "");
                //fiscalprinter.PrintRecItem("ES Servizio ES", (decimal)200000, (int)1000, (int)13, (decimal)200000, "");


                fiscalprinter.PrintRecTotal((decimal)5000000, (decimal)5000000, "502NON RISCOSSO SERVIZI");
                ...
                */
                ...
                fiscalprinter.PrintRecItem("BENE 4", (decimal)200000, (int)1000, (int)3, (decimal)200000, "");
        ...
        public int testCNRAnnullo()
        {
            try
            {
                ...
                */
                ...
                if (!(String.Equals(iObj[0], "51")))
                {
                    log.Error("Error DirectIO 1078 operator, expected 51, received " + iObj[0]);
                    //throw new Exception();
                }
        ...
        public int testCNRResi()
        {
            try
            {
                ...
                fiscalprinter.PrintRecRefund("BENE 4", (decimal)200000, (int)3);
                fiscalprinter.PrintRecItemAdjustment(FiscalAdjustment.AmountDiscount, "001", 200000, 3);
        ...
        public int TestCamilloTicket()
        {
            try
            {
                log.Info("Performing TestCamilloTicket Method() Esempio 20");
                ...
                fiscalprinter.BeginFiscalReceipt(true);
                fiscalprinter.PrintRecItem("Test Ticket ", (decimal)45000, (int)1000, (int)1, (decimal)45000, "");

                
                fiscalprinter.PrintRecSubtotal((decimal)45000);

                fiscalprinter.PrintRecTotal((decimal)45000, (decimal)5000, "0CONTANTI");
                fiscalprinter.PrintRecTotal((decimal)45000, (decimal)20000, "401TICKET");
                fiscalprinter.PrintRecTotal((decimal)45000, (decimal)10000, "402TICKET");
        ...
        public int TestAnnulloOmaggioBuonoMUNonRiscosso()
        {
            try
            {
                log.Info("Performing TestAnnulloOmaggioBuonoMUNonRiscosso Method() ");
                ...
                fiscalprinter.BeginFiscalReceipt(true);
                fiscalprinter.PrintRecItem("Servizio 10", (decimal)100000, (int)1000, (int)11, (decimal)100000, "");
                fiscalprinter.PrintRecItemAdjustment(FiscalAdjustment.AmountDiscount, "001Omaggio", 100000, 1);
                fiscalprinter.PrintRecItem("SERVIZIO 22", (decimal)200000, (int)1000, (int)10, (decimal)200000, "");

                fiscalprinter.PrintRecTotal((decimal)200000, (decimal)200000, "502NON RISCOSSO SERVIZI");
                fiscalprinter.EndFiscalReceipt(false);
                ...
                fiscalprinter.BeginFiscalReceipt(true);
                fiscalprinter.PrintRecItem("Servizio 10", (decimal)100000, (int)1000, (int)11, (decimal)100000, "");
                fiscalprinter.PrintRecItemAdjustment(FiscalAdjustment.AmountDiscount, "002Buono Monouso", 100000, 1);
                fiscalprinter.PrintRecItem("SERVIZIO 22", (decimal)200000, (int)1000, (int)10, (decimal)200000, "");
                ...
                */
                ...
                foreach (string namefile in sortAscendingQuery)
                {
                    ...
                    if ((String.Compare(namefile, @"D:\Epson_Copia_Chiavetta_Gialla2\Server\XmlPerServer\3CreateToken.xml") == 0) ||
                        ...
                        (String.Compare(namefile, @"D:\Epson_Copia_Chiavetta_Gialla2\Server\XmlPerServer\4Esempio1CNRVoid.xml") == 0) ||
                        ...
                        (String.Compare(namefile, @"D:\Epson_Copia_Chiavetta_Gialla2\Server\XmlPerServer\3VenditaConBug.xml") == 0) ||
                        (String.Compare(namefile, @"D:\Epson_Copia_Chiavetta_Gialla2\Server\XmlPerServer\4ProvaBugAndrea.xml") == 0) ||
                        (String.Compare(namefile, @"D:\Epson_Copia_Chiavetta_Gialla2\Server\XmlPerServer\4EsempioTicketCamillo.xml") == 0) ||
                        (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4TestIvaMinima.xml") == 0) ||
...

                    {
                      ...
                      //Xld.LoadXml(@"G:\Server\XmlPerServer\rt_server_create_receipt_lottery.xml");
                        ...
                        if ((String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4VenditaconLotteria.xml") == 0) ||
                            ...
                            (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4Esempio8CNRLottery.xml") == 0))
                        {
                            int iteration = 1; //numero di scontrini che verranno inoltrati
                            ...
                            for (int i = 0; i < iteration; i++)
                            {
                                ...
                                if (Place != -1) //E' un comando con un tillID
                                {
                                    ...
                                    */
                                    ...
                                    if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\3VenditaConBug.xml") == 0 )
                                    {
                                        dailyAmount += 9.11m;
                                    }
                                    if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4ProvaBugAndrea.xml") == 0 )
                                    {
                                        dailyAmount += 0.02m;
                                    }
                                    if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4EsempioTicketCamillo.xml") == 0 )
                                    {
                                        dailyAmount += 4.50m;
                                    }
                                    if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4TestIvaMinima.xml") == 0)
                                    {
                                        dailyAmount += 0.43m;
                                    }
                        ...
                        else
                        {
                            if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\3CreateToken.xml") != 0)
                            {
                                //Per sicurezza la chiusura server la faccio se e solo se la ricevo da cassa 1
                                ...
                                {
                                    if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\4Esempio1CNRVoid.xml") == 0)
                                    {
                                        //chiamo la CreateToken per aggiornare i dati della cassa relativa
                                        sck.Shutdown(SocketShutdown.Both);
                                        sck.Close();
                                        ...
                                        Console.WriteLine("TillID = {0},  Last recNumber = {1}, DailyAmount = {2}", TillID, Client.DocNum, Client.DailyAmount);

                                        int Place = 0;
                                        string msgOutput = String.Empty;
                                        //Prima di inviare l'XML relativo dobbiamo riempire i campi con i dati corretti e formattati bene
                                        Place = msgInput.IndexOf("recNumber");

                                        if (Place != -1) //E' un comando con un tillID
                                        {
                                            int recNumber = Client.DocNum;
                                            msgOutput = msgInput.Remove(Place + 11, 4).Insert(Place + 11, recNumber.ToString().PadLeft(4, '0'));
                                            //in progress TODO 260520
                                            /*
                                            Place = msgInput.IndexOf("payment");
                                            decimal payment = Convert.ToDecimal(msgInput.Substring(Place + 9));
                                        ...
                                        Place = msgInput.IndexOf("refZRepNum");
                                        if (Place != -1)
                                        {
                                            zRepNum = Client.ZRep;
                                            msgOutput = msgOutput.Remove(Place + 12, 4).Insert(Place + 12, zRepNum.ToString().PadLeft(4, '0'));
                                        ...
                                        Place = msgInput.IndexOf("refRecNum");
                                        if (Place != -1)
                                        {
                                            int recNumber = Client.DocNum;
                                            msgOutput = msgInput.Remove(Place + 11, 4).Insert(Place + 11, recNumber.ToString().PadLeft(4, '0'));
                                        ...
                                        Place = msgInput.IndexOf("refTillID");
                                        if (Place != -1) 
                                        {
                                            msgOutput = msgInput.Remove(Place + 11, 8).Insert(Place + 11, TillID);
                                            msgInput = msgOutput;

                                        }
                                        Place = msgInput.IndexOf("refDate");
                                        if (Place != -1)
                                        {
                                            msgOutput = msgOutput.Remove(Place + 9, 8).Insert(Place + 9, time.Substring(0,8));
                                        }
                                        ...
                                        Console.WriteLine("Test invio void scontrino");
                                        Console.WriteLine("Received: {0} for the thread of tillId:= {1} about the XML command: {2}", Encoding.Default.GetString(receiveBuffer), TillID, namefile);
                                        sck.Shutdown(SocketShutdown.Both);
                                        sck.Close();
                                    ...
                                    else //non so quando e come arrivo qui ma lo metto uguale, TODO da controllare (no chiusuraserver e no void e no token)
                                    {
                                        sck.Send(msgBuffer, 0, msgBuffer.Length, SocketFlags.None);
                                        ...
                                        {
                                            System.IO.StreamWriter file = new System.IO.StreamWriter("D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\" + "Report" + TillID + ".txt", false);
                                            file.WriteLine(info);
                                            file.Close();
                                        ...
                                        //Il Report di risposta di ogni cassa me lo scrivo su file (separato per ogni cassa obv)
                                        if (String.Compare(namefile, "D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\9CreateReportServer.xml") == 0)
                                        {
                                            System.IO.StreamWriter file = new System.IO.StreamWriter("D:\\Epson_Copia_Chiavetta_Gialla2\\Server\\XmlPerServer\\" + "Report" + "Server" + ".txt", false);
                                            file.WriteLine(info);
                                            file.Close();
